...
//ubi
api_v2.post(
  '/transactions/ubi/claimfunds',
  authenticateToken,
  transactionUbiClaimFunds
);
api_v2.post(
  '/transactions/ubi/checkIfBeneficiary',
  authenticateToken,
  transactionUbiCheckBeneficiary
);
api_v2.post(
  '/transactions/ubi/setBeneficiary',
  authenticateToken,
  transactionUbiSetBeneficiary
);

//momo
api_v2.post(
  '/transactions/deposit/momo',
  authenticateToken,
  transactionDepositMomo
);
api_v2.post(
...
api_v2.post(
  ...
  authenticateToken,
  transactionsGetEscrow
);
api_v2.post(
  '/transactions/transfer/p2p',
  authenticateToken,
